...
const ProductCategory = () => {
  const { data, isLoading, refetch } = useGetAllProductCategoriesQuery();
  ...
  const handleDelete = async (id) => {
    try {
      ...
      if (res?.data?.success) {
        ...
        refetch(); // immediately get fresh data
      } else {
  ...
  return (
    <div className="p-4 w-full bg-white">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-xl font-bold uppercase">Blog Categories</h1>
        <button
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/60 z-50 ">
          <div className="bg-white w-full max-w-md p-6 rounded-sm">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button
                onClick={handleSave}
                className="px-4 py-2 bg-blue-700 text-white hover:bg-gray-300"
              >
                Save
              </button>
            </div>
